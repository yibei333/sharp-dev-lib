...
#### ExecuteDataSetAsync(CancellationToken cancellationToken, String sql, DbParameter[] parameters) 方法
...
public Task<DataSet> ExecuteDataSetAsync(CancellationToken cancellationToken, String sql, DbParameter[] parameters)
```
