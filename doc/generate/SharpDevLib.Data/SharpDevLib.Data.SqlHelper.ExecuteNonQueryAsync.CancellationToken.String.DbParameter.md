...
#### ExecuteNonQueryAsync(CancellationToken cancellationToken, String sql, DbParameter[] parameters) 方法
...
public Task<Int32> ExecuteNonQueryAsync(CancellationToken cancellationToken, String sql, DbParameter[] parameters)
```
