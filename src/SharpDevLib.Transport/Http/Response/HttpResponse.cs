...
public class HttpResponse
{
    ...
    public override string ToString()
    {
        ...
        if (Headers.NotNullOrEmpty()) builder.AppendLine($"Headers:{JsonSerializer.Serialize(Headers)}");
        if (Cookies.NotNullOrEmpty()) builder.AppendLine($"Cookies:{JsonSerializer.Serialize(Cookies.Select(x => new { x.Name, x.Value }))}");
