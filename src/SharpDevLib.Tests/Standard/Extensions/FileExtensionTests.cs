...
public class FileExtensionTests
{
    ...
    {
        var path = AppDomain.CurrentDomain.BaseDirectory.CombinePath("Data/c-sharp.png");
    ...
    {
        var sourcePath = AppDomain.CurrentDomain.BaseDirectory.CombinePath("Data/c-sharp.png");
        var targetPath = AppDomain.CurrentDomain.BaseDirectory.CombinePath("Data/c-sharp-decode.png");
